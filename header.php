				...
				<div class="col s12">
					<div class="header-wrapper">
						<div class="<?php get_site_url(); ?> wp-content/themes/fedora-id/site-branding">
							<div class="logo">
								<img src="http://localhost/personal/fedora.or.id/wp-content/uploads/2015/06/Logo_fedoralogo1.png" />
							</div>
							<div class="indonesia">Indonesia</div>
							<p><em id="fedora-motto">Freedom, Friends, Features, First</em></p>
							<p><a class="waves-effect waves-light btn-large"><i class="mdi-file-cloud-download left"></i>Download Fedora 22</a></p>
					</div>
				</div>
			</div>
		</div>
